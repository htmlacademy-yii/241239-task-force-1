                    ...
                    <?php foreach ($tasks as $task):?>
                        <div class="new-task__card">
                            <div class="new-task__title">
                                <a href="<?=Url::to(['/tasks/view/' . $task->id])?>" class="link-regular"><h2><?= Html::encode($task->name); ?></h2></a>
                            ...
                            <b class="new-task__price new-task__price--<?= $task->category->icon; ?>"><?= Html::encode($task->price); ?><b> ₽</b></b>
